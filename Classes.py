...
class Menu:
    ...
    def printHeader(self):
        ...
        print("\n{}{} {}\n".format(Globals.prefixIndent, Globals.dictIcons.get("app"), Globals.appName))
        icon = Globals.dictIcons.get(self.icon) or Globals.dictIcons.get("default")
        print("{}{} {}\n".format(Globals.prefixIndent, icon, self.title.upper()))

    def printOptions(self):
        for key in self.options:
            [icon, name] = self.options.get(key)
            print("{}({}) {} {}".format(Globals.prefixIndent, key, Globals.dictIcons.get(icon), name))
        print("\n")
